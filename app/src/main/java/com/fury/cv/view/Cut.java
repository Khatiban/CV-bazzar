                        ...
                        if (all_out < duration) {
                            ...
                            try {
                                ...
                                if (coinint <= 0){
                                    ...
                                    one_play_editor.putString("b_S_t", "در حال برش ویدیو ...");
                                    one_play_editor.putString("b_F_c", "متاسفانه برش ویدیو انجام نشد!");
                                    one_play_editor.putString("b_E_t", "برش ویدیو");
                            ...
                            Toast.makeText(Cut.this, "زمان پایان برش از زمان کل ویدیو بیشتر است !", Toast.LENGTH_LONG).show();
                        }
                    } else {
                        Toast.makeText(Cut.this, "زمان شروع برش از زمان کل ویدیو بیشتر است !", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(Cut.this, "زمان شروع و پایان برش درست نمی باشد !", Toast.LENGTH_LONG).show();
                }
            } else {
                Toast.makeText(Cut.this, "زمان شروع و پایان برش درست نمی باشد !", Toast.LENGTH_LONG).show();
            }
    ...
    private void findById() {
        ...
        btnSetting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                (new DialogHelp(Cut.this,"برای برش ویدیو مورد نظر لطفا ابتدا زمان شروع ویدیو را وارد کنید و بعد زمانی که می خواهید به پایان برسد را مشخص کنید و در قسمت زمان پایان وارد کنید ، بعد وارد کردن مقدار خواسته شده دکمه شروع را بزنید و منتظر انجام دادن کار شود \n توجه داشته باشید که زمان شروع از زمان پایان نباید بیشتر شود \n اگر زمان را دستی وارد می کنید توجه کنید که زمان ها درست باشد \n در صورتی که به مشکلی یا خطایی مشاهده کردید از طریق پشتیبانی به ما خبر دهید تا رسیدگی شود.")).showDialog();
            }
        });
