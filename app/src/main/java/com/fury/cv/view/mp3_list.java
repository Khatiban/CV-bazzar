...
public class mp3_list extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textnot.setText("صوتی وجود ندارد \n برای جدا کردن صوت از ویدیو بر روی دکمه + کلیک کنید و ویدیو مورد نظر را انتخاب کنید");
    ...
    public void deleteTmpFile(int videopath) {
        ...
        if (file.exists()) {
            try {
                ...
                Toast.makeText(getApplicationContext(), "صوت با موفقیت حذف شد.", Toast.LENGTH_SHORT).show();
            } catch (Exception e) {
